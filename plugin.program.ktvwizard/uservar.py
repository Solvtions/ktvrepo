...
ICONYOUTUBE    = 'http://kritiktv.net/ktv/Images/youtube.jpg'
ICONSAVE       = 'http://kritiktv.net/ktv/Images/save.jpg'
ICONTRAKT      = 'http://kritiktv.net/ktv/Images/trakt.jpg'
ICONREAL       = 'http://kritiktv.net/ktv/Images/debrid.jpg'
ICONLOGIN      = 'http://kritiktv.net/ktv/Images/login.jpg'
ICONCONTACT    = 'http://kritiktv.net/ktv/Images/contact.jpg'
ICONSETTINGS   = 'http://kritiktv.net/ktv/Images/settings.jpg'
...
THEME1         = '[COLOR '+COLOR1+'][B]([COLOR '+COLOR2+']Kritik TV Wizard[/COLOR])[/B][/COLOR] [COLOR '+COLOR2+']%s[/COLOR]'
